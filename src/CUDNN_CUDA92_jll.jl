...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import CUDNN_CUDA92_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("75b8dd0a-07b1-5bf5-8859-e3022e43e992"))
platforms = [Pkg.Artifacts.unpack_platform(e, "CUDNN_CUDA92", artifacts_toml) for e in artifacts["CUDNN_CUDA92"]]
...
if best_platform === nothing
    @debug("Unable to load CUDNN_CUDA92; unsupported platform $(triplet(platform_key_abi()))")
else
